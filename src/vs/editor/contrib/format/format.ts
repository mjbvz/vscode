...
import { registerLanguageCommandNew, ServicesAccessor } from 'vs/editor/browser/editorExtensions';
...
registerLanguageCommandNew('_executeFormatRangeProvider', function (accessor, args) {
...
registerLanguageCommandNew('_executeFormatDocumentProvider', function (accessor, args) {
...
registerLanguageCommandNew('_executeFormatOnTypeProvider', function (accessor, args) {
