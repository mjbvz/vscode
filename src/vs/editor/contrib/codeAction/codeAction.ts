...
import { CodeActionOld as CodeActiona, CodeActionContext, CodeActionProviderRegistry, CodeActionTrigger as CodeActionTriggerKind } from 'vs/editor/common/modes';
...
export function getCodeActionNEW(
	model: ITextModel,
...
registerLanguageCommand('_executeCodeActionProvider', async function (accessor, args): Promise<ReadonlyArray<CodeActiona>> {
	...
	const codeActionSet = await getCodeActionNEW(
		model,
